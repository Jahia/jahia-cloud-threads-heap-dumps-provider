    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="box-1" ng-controller="folderPickerCtrl"
                 ng-init='init(${localFolders}, "${fn:escapeXml(jahiaCloudDumpFactory.localPath)}", "localPath", true, "${i18NSelectTarget}")'>
                <form:form modelAttribute="jahiaCloudDumpFactory" method="post" cssClass="form">
