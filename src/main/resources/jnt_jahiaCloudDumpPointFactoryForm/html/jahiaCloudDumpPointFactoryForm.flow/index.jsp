...
<%--@elvariable id="jahiaCloudDumpFactory" type="org.jahia.community.external.cloud.factory.JahiaCloudDumpMountPointFactory"--%>
...
<div class="folderPickerApp" ng-app="folderPicker">
    <h2><fmt:message key="jahiaCloudDumpFactory"/></h2>
    <%@ include file="errors.jspf" %>

    <fmt:message var="selectTarget" key="jahiaCloudDumpFactory.selectTarget"/>
    <c:set var="i18NSelectTarget" value="${functions:escapeJavaScript(selectTarget)}"/>
    <div class="box-1" ng-controller="folderPickerCtrl" ng-init='init(${localFolders}, "${fn:escapeXml(jahiaCloudDumpFactory.localPath)}", "localPath", true, "${i18NSelectTarget}")'>
        <form:form modelAttribute="jahiaCloudDumpFactory" method="post">
